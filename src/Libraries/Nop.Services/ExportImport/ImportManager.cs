    ...
    public partial class ImportManager : IImportManager
    {
        ...
        public virtual void ImportProductsFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("ImportProducts", null, 
                    _localizationService.GetResource("ActivityLog.ImportProducts"), countProductsInFile);
            }
        }
        ...
        public virtual int ImportStatesFromTxt(Stream stream)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("ImportStates", null,
                _localizationService.GetResource("ActivityLog.ImportStates"), count);
        ...
        public virtual void ImportManufacturersFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("ImportManufacturers", null, 
                    _localizationService.GetResource("ActivityLog.ImportManufacturers"), iRow - 2);
            }
        }
        ...
        public virtual void ImportCategoriesFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("ImportCategories", null, 
                    _localizationService.GetResource("ActivityLog.ImportCategories"), iRow - 2 - saveNextTime.Count);
