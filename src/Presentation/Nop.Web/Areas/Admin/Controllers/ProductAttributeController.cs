    ...
    public partial class ProductAttributeController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewProductAttribute", productAttribute.Id,
        ...
        public virtual IActionResult Edit(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("EditProductAttribute", productAttribute.Id,
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteProductAttribute", productAttribute.Id,
