    ...
    public partial class CustomerController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(CustomerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewCustomer", customer.Id,
        ...
        public virtual IActionResult Edit(CustomerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //activity log
                    _customerActivityService.InsertActivity("EditCustomer", customer.Id,
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("DeleteCustomer", customer.Id,
        ...
        public virtual IActionResult Impersonate(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("Impersonation.Started", customer.Id, 
                _localizationService.GetResource("ActivityLog.Impersonation.Started.StoreOwner"), customer.Email, customer.Id);
            _customerActivityService.InsertActivity(customer, "Impersonation.Started", _workContext.CurrentCustomer.Id, 
