...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class MeasureController : BaseAdminController
	{
        ...
        public virtual IActionResult WeightUpdate(MeasureWeightModel model)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("EditMeasureWeight", weight.Id,
                _localizationService.GetResource("ActivityLog.EditMeasureWeight"), weight.Id);
        ...
        public virtual IActionResult WeightAdd(MeasureWeightModel model)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("AddNewMeasureWeight", weight.Id,
                _localizationService.GetResource("ActivityLog.AddNewMeasureWeight"), weight.Id);
        ...
        public virtual IActionResult WeightDelete(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteMeasureWeight", weight.Id,
                _localizationService.GetResource("ActivityLog.DeleteMeasureWeight"), weight.Id);
        ...
        public virtual IActionResult DimensionUpdate(MeasureDimensionModel model)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("EditMeasureDimension", dimension.Id,
                _localizationService.GetResource("ActivityLog.EditMeasureDimension"), dimension.Id);
        ...
        public virtual IActionResult DimensionAdd(MeasureDimensionModel model)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("AddNewMeasureDimension", dimension.Id,
                _localizationService.GetResource("ActivityLog.AddNewMeasureDimension"), dimension.Id);
        ...
        public virtual IActionResult DimensionDelete(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteMeasureDimension", dimension.Id,
                _localizationService.GetResource("ActivityLog.DeleteMeasureDimension"), dimension.Id);
