	...
	public partial class EmailAccountController : BaseAdminController
	{
		...
		public virtual IActionResult Create(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewEmailAccount", emailAccount.Id,
                    _localizationService.GetResource("ActivityLog.AddNewEmailAccount"), emailAccount.Id);
        ...
        public virtual IActionResult Edit(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("EditEmailAccount", emailAccount.Id,
                    _localizationService.GetResource("ActivityLog.EditEmailAccount"), emailAccount.Id);
	    ...
	    public virtual IActionResult Delete(int id)
	    {
	        ...
	        try
	        {
                ...
                //activity log
                _customerActivityService.InsertActivity("DeleteEmailAccount", emailAccount.Id,
                    _localizationService.GetResource("ActivityLog.DeleteEmailAccount"), emailAccount.Id);
