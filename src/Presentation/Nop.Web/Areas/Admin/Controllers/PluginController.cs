    ...
    public partial class PluginController : BaseAdminController
	{
	    ...
	    public virtual IActionResult UploadPluginsAndThemes(IFormFile archivefile)
	    {
	        ...
	        try
	        {
                ...
                {
                    _customerActivityService.InsertActivity("UploadNewPlugin", null,
                ...
                {
                    _customerActivityService.InsertActivity("UploadNewTheme", null, 
        ...
        public virtual IActionResult Install(IFormCollection form)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("InstallNewPlugin", null,
                    _localizationService.GetResource("ActivityLog.InstallNewPlugin"), pluginDescriptor.FriendlyName);
        ...
        public virtual IActionResult Uninstall(IFormCollection form)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("UninstallPlugin", null,
                    _localizationService.GetResource("ActivityLog.UninstallPlugin"), pluginDescriptor.FriendlyName);
	    ...
	    public virtual IActionResult Delete(IFormCollection form)
	    {
	        ...
	        try
	        {
                ...
                //activity log
                _customerActivityService.InsertActivity("DeletePlugin", null,
                    _localizationService.GetResource("ActivityLog.DeletePlugin"), pluginDescriptor.FriendlyName);
        ...
        public virtual IActionResult EditPopup(PluginModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (pluginDescriptor.Installed)
                {
                    ...
                    //activity log
                    _customerActivityService.InsertActivity("EditPlugin", null,
                        _localizationService.GetResource("ActivityLog.EditPlugin"), pluginDescriptor.FriendlyName);
                }
