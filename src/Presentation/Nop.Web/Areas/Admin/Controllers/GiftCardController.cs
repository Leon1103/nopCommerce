    ...
    public partial class GiftCardController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(GiftCardModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewGiftCard", giftCard.Id,
        ...
        public virtual IActionResult Edit(GiftCardModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("EditGiftCard", giftCard.Id,
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteGiftCard", giftCard.Id,
                _localizationService.GetResource("ActivityLog.DeleteGiftCard"), giftCard.GiftCardCouponCode);
