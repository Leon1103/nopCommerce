    ...
    public partial class StoreController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(StoreModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewStore", store.Id,
                    _localizationService.GetResource("ActivityLog.AddNewStore"), store.Id);
        ...
        public virtual IActionResult Edit(StoreModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("EditStore", store.Id,
                    _localizationService.GetResource("ActivityLog.EditStore"), store.Id);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("DeleteStore", store.Id,
                    _localizationService.GetResource("ActivityLog.DeleteStore"), store.Id);
