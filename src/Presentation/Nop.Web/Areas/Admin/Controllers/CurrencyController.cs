    ...
    public partial class CurrencyController :  BaseAdminController
    {
        ...
        public virtual IActionResult Create(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("AddNewCurrency", currency.Id,
                    _localizationService.GetResource("ActivityLog.AddNewCurrency"), currency.Id);
        ...
        public virtual IActionResult Edit(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("EditCurrency", currency.Id,
                    _localizationService.GetResource("ActivityLog.EditCurrency"), currency.Id);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("DeleteCurrency", currency.Id,
                    _localizationService.GetResource("ActivityLog.DeleteCurrency"), currency.Id);
