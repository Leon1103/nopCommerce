...
namespace Nop.Web.Controllers
{
    public partial class ProductController : BasePublicController
    {
        ...
        public virtual IActionResult ProductDetails(int productId, int updatecartitemid = 0)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("PublicStore.ViewProduct", product.Id,
                _localizationService.GetResource("ActivityLog.PublicStore.ViewProduct"), product.Name);
        ...
        public virtual IActionResult ProductReviewsAdd(int productId, ProductReviewsModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("PublicStore.AddProductReview", product.Id,
                    _localizationService.GetResource("ActivityLog.PublicStore.AddProductReview"), product.Name);
        ...
        public virtual IActionResult AddProductToCompareList(int productId)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("PublicStore.AddToCompareList", product.Id,
                _localizationService.GetResource("ActivityLog.PublicStore.AddToCompareList"), product.Name);
